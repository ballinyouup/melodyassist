...
import Right from "./components/Generate/RightColumn";
...
const Generate = () => {
  ...
  return (
    <div className="h-full w-full">
      ...
      <label
        htmlFor="my-modal-4"
        className="modal cursor-pointer bg-base-100 bg-opacity-90"
      >
        <label
          className="modal-box relative flex w-fit flex-col items-center bg-base-300"
          data-theme={userData.data?.theme ?? "winter"}
          htmlFor=""
        >
          <p className="pt-2 font-bold">
            Are you sure you want to delete all audio?
          </p>
          <span className="py-2">
            <i>* Warning Audio cannot be recovered *</i>
          </span>
